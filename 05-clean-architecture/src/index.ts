...
import { AxiosAdapter } from "./infra/http/HttpClient.ts";
import { ExpressAdapter } from "./infra/http/HttpServer.ts";
import { AccountRepositoryDatabase } from "./infra/repository/AccountRepository.ts";
...
new Deposit(accountRepository, paymentGateway);
