...
export class PaymentGatewayHttp implements PaymentGateway {
  ...
  async processTransaction(input: Input): Promise<any> {
    ...
    const outputCreateToken = await this.httpClient.post(
      `https://sandbox.pjbank.com.br/recebimentos/e0727263cc7a983f0aae5411ad86c5a144b8ed28/tokens`,
      creditCard,
      headers,
    );
    let transaction = {
    ...
    const outputCreateTransaction = await this.httpClient.post(
      `https://sandbox.pjbank.com.br/recebimentos/e0727263cc7a983f0aae5411ad86c5a144b8ed28/transacoes`,
      transaction,
      headers,
    );
