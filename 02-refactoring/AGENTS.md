...
> [.agents/skills/test-automation/](.agents/skills/test-automation/SKILL.md) and follow
...
[.agents/skills/test-automation/](.agents/skills/test-automation/SKILL.md); it is the
reference for tooling, structure, isolation, test levels, and coverage targets. agents
